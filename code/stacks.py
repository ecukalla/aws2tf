...
def getstackresources(stack_name,client):
    ...
    for j in response:
            ...
            elif type == "AWS::AIOps::Investigation": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::ARCRegionSwitch::RegionSwitch": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ARCZonalShift::ZonalAutoshiftConfiguration": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ASK::Skill": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::ApplicationSignals::ServiceLevelObjective": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::AppTest::TestCase": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::BCMDataExports::Export": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Bedrock::Agent": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Bedrock::AgentAlias": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Bedrock::DataSource": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Bedrock::FlowAlias": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Bedrock::FlowVersion": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Bedrock::Guardrail": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Bedrock::GuardrailVersion": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Bedrock::KnowledgeBase": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Bedrock::Prompt": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Bedrock::PromptVersion": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::BedrockAgentCore::AgentVersion": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Billing::BillingView": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::BillingConductor::BillingGroup": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::BillingConductor::CustomLineItem": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::BillingConductor::PricingPlan": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::BillingConductor::PricingRule": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Cases::Domain": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Cases::IntegrationAssociation": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::CleanRoomsML::TrainingDataset": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::CloudWatch::InsightRule": common.call_resource("aws_cloudwatch_contributor_insight_rule", parn)
            ...
            elif type == "AWS::CodeConnections::Connection": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::CodeConnections::RepositoryLink": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::CodeConnections::SyncConfiguration": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::ConnectCampaignsV2::Campaign": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::CUR::ReportDefinition": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Deadline::Farm": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Deadline::Fleet": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Deadline::LicenseEndpoint": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Deadline::MeteredProduct": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Deadline::Monitor": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Deadline::Queue": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Deadline::QueueEnvironment": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Deadline::QueueFleetAssociation": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Deadline::StorageProfile": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::DevOpsAgent::AgentConfiguration": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::DSQL::Cluster": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::ECS::ExpressGatewayService": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::EVS::Cluster": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::GameLiftStreams::Stream": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::IoTFleetWise::Campaign": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::IoTFleetWise::DecoderManifest": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::IoTFleetWise::Fleet": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::IoTFleetWise::ModelManifest": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::IoTFleetWise::SignalCatalog": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::IoTFleetWise::Vehicle": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::IoTManagedIntegrations::Integration": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Invoicing::InvoiceUnit": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::LookoutEquipment::InferenceScheduler": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::MPA::ApprovalRuleTemplate": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Notifications::ChannelAssociation": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Notifications::EventRule": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Notifications::ManagedNotificationAccountContactAssociation": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Notifications::ManagedNotificationAdditionalChannelAssociation": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Notifications::NotificationConfiguration": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Notifications::NotificationHub": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Notifications::OrganizationalUnitAssociation": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::NotificationsContacts::EmailContact": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::ObservabilityAdmin::ObservabilityConfiguration": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ODB::DatabaseInstance": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::PCAConnectorSCEP::Challenge": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::PCAConnectorSCEP::Connector": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::PCS::Cluster": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::PCS::ComputeNodeGroup": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::PCS::Queue": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::PaymentCryptography::Alias": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::PaymentCryptography::Key": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::QBusiness::Application": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::QBusiness::DataSource": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::QBusiness::Index": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::QBusiness::Plugin": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::QBusiness::Retriever": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::QBusiness::WebExperience": common.call_resource("aws_null", type+" "+pid)
...
#            elif type == "AWS::QLDB::Stream": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Rbin::Rule": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Route53Profiles::Profile": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Route53Profiles::ProfileAssociation": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Route53Profiles::ProfileResourceAssociation": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::RTBFabric::Endpoint": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::SMSVOICE::ConfigurationSet": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::SMSVOICE::OptOutList": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::SMSVOICE::PhoneNumber": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::SMSVOICE::Pool": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::SSMGuiConnect::Preferences": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::SSMQuickSetup::ConfigurationManager": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Scheduler::ScheduleGroup": common.call_resource("aws_scheduler_schedule_group", pid)
